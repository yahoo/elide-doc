...
The successful completion of a TableExport request will return a URL to download the results as shown in the example response below. Opening the URL in any browser of your choice will start downloading the results to your machine.
